<?php /* Smarty version 2.6.26, created on 2016-05-06 16:19:30
...
" />
      ...
      <td valign="top">
       <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
        ...
        <?php $_from = $this->_tpl_vars['show_list_bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['show_list']):
?>
        <?php if ($this->_tpl_vars['show_list']['id'] == $this->_tpl_vars['id']): ?>
        <form action="show.php?rec=update" method="post" enctype="multipart/form-data">
...
" />
      ...
      <td valign="top">
       <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
        ...
        <?php $_from = $this->_tpl_vars['show_list_middle']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['show_list']):
?>
        <?php if ($this->_tpl_vars['show_list']['id'] == $this->_tpl_vars['id']): ?>
        <form action="show.php?rec=update" method="post" enctype="multipart/form-data">
