...
//$smarty->assign('art_cate_act', $dou->get_category('article_category',0,7));
$smarty->assign('recommend_article1',$dou->get_article_list('1', '6', 'recommend'));
$smarty->assign('recommend_article2',$dou->get_article_list('2', '6', 'recommend'));
$smarty->assign('recommend_article3',$dou->get_article_list('3', '6', 'recommend'));
$smarty->assign('recommend_article4',$dou->get_article_list('4', '6', 'recommend'));
$smarty->assign('recommend_article5',$dou->get_article_list('5', '6', 'recommend'));
