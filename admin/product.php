...
elseif ($rec == 'insert') {
    ...
    $sql = "INSERT INTO " . $dou->table('product') .
             " (id, cat_id, product_name, price, defined, content, product_image ,keywords, add_time, description, sex,birth,title,subject,officephone,mail,office)" .
             " VALUES (NULL, '$_POST[cat_id]', '$_POST[product_name]', '$_POST[price]', '$_POST[defined]', '$_POST[content]', '$file', '$_POST[keywords]', '$add_time', '$_POST[description]' ,'$_POST[sex]','$_POST[birth]','$_POST[title]','$_POST[subject]','$_POST[officephone]','$_POST[mail]','$_POST[office]')";
    $dou->query($sql);
...
elseif ($rec == 'update') {
    ...
    $sql = "update " . $dou->table('product') .
             ...
             $up_file . ", keywords = '$_POST[keywords]', description = '$_POST[description]', sex = '$_POST[sex]', birth = '$_POST[birth]', title = '$_POST[title]', subject = '$_POST[subject]', officephone = '$_POST[officephone]', mail = '$_POST[mail]', office = '$_POST[office]' WHERE id = '$_POST[id]'";
    $dou->query($sql);
